...
const PreviewHeader = ({ reportData }) => {
  return (
    <>
      {/* Header Logo */}
      ...
      <header className="mb-10 relative z-10">
        <h1 className="text-lg font-bold uppercase tracking-tight border-b-2 border-black pb-2 mb-4">
          {reportData.title || '[TÍTULO DO RELATÓRIO]'}
        </h1>
        
        <div className="text-right text-[12px] space-y-0.5">
          <p className="font-bold text-[14px]">{reportData.qaName || 'NOME DO ANALISTA'}</p>
          <p>{reportData.role || 'Cargo'}</p>

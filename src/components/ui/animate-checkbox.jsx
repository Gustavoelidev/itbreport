  ...
  return (
    ...
    >
      <CheckboxPrimitive.Root
        ...
        disabled={disabled}
        className={cn(
          "flex items-center justify-center border border-[#bbcad2] data-[state=checked]:border-[#00a335] data-[state=checked]:bg-[#00a335] data-[state=checked]:text-white size-4 shrink-0 rounded-[4px] transition-all duration-200 outline-none focus-visible:ring-2 focus-visible:ring-[#00a335]/50 disabled:cursor-not-allowed disabled:opacity-50 hover:shadow-sm hover:border-[#00a335]/40",
          className
        )}
        {...props}
      >
